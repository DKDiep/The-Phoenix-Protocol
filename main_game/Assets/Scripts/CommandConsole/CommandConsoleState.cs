...
#pragma warning restore 0649
    ...
    {
        if (repairProgress[componentToUpgrade] == 1 || gameState.GetComponentHealth((ComponentType)component) > consoleUpgrades[component].maxHealth || component > 3) //components 4 and 5 can't be repaired
            return;
