...
\begin{itemize}
  ...
  \item Intuitive input methods including a touch screen, infrared controllers, and two different joysticks, catered specifically for each role to give the best feedback possible and maximise immersion \todo{change this. Good enough?}
...
% TODO: might want to change the labels below
